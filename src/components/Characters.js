...
const Characters = () => {
    ...
    let [attack1, setAttack1] = useState('');
    let [attack2, setAttack2] = useState('');
    let [attack3, setAttack3] = useState('');
    let [image1, setImage1] = useState('');
    let [image2, setImage2] = useState('');
    let [image3, setImage3] = useState('');
    let [invuln, setInvuln] = useState('');
                    ...
                    return (
                        <div key={char.id} className={CharactersCSS.characterContainer}>
                            ...
                            <div className={CharactersCSS.skillImages}>
                                <img className={CharactersCSS.image} src={char.pfp.img} ></img>
                                <img className={CharactersCSS.image} onClick={(e) => { toggleDescription(e, id, name, char.attack1.img, skill1) }} src={char.attack1.img}></img>
                                <img className={CharactersCSS.image} onClick={(e) => { toggleDescription(e, id, name, char.attack2.img, skill2) }} src={char.attack2.img}></img>
                                <img className={CharactersCSS.image} onClick={(e) => { toggleDescription(e, id, name, char.attack3.img, skill3) }} src={char.attack3.img}></img>
                                <img className={CharactersCSS.image} onClick={(e) => { toggleDescription(e, id, name, char.invul.img, skill4) }} src={char.invul.img} />
